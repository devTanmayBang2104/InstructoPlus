...
function SearchWithAi() {
  ...
  const handleRecommendation = async (query) => {
    try {
      ...
      if (Array.isArray(result.data)) {
      ...
      } else if (result.data && result.data.courses) {
        // Handle old response format if needed
        ...
        // If no valid data format is found
        setRecommendations([]);
        speak("No courses found");
      }
      ...
      setRecommendations([]);
      setListening(false);
      speak("Sorry, there was an error with the search");
    }
  };
